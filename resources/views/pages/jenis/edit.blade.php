    ...
    <!-- Page Title -->
        <div class="page-title dark-background" data-aos="fade"
            ...
            <div class="container position-relative">
                <h1>Edit Jenis Penggunaan</h1>
                <p>Perbarui informasi jenis penggunaan lahan persil.</p>
            ...
            <div class="container py-4">
                ...
                <div class="card shadow-lg border-0 p-4" style="border-radius: 20px;">
                    <h4 class="mb-4 fw-bold">
                        <i class="bi bi-pencil-square me-2"></i> Form Edit Jenis Penggunaan
                    </h4>
                    ...
                    <form method="POST" action="{{ route('jenis.update', $jenis) }}" enctype="multipart/form-data">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="nama_penggunaan"
                                    value="{{ old('nama_penggunaan', $jenis->nama_penggunaan) }}"
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea name="keterangan" class="form-control" rows="3">{{ old('keterangan', $jenis->keterangan) }}</textarea>
                            </div>
