                ...
                <div class="row justify-content-center text-center">
                    <div class="col-lg-8">
                        <div class="hero-content">
                            ...
                            <p data-aos="fade-up" data-aos-delay="300">We deliver comprehensive construction solutions
                                with unwavering commitment to quality, safety, and timely completion. Trust our
                                experienced team to bring your vision to life with precision and professionalism.</p>

                            <div class="hero-actions" data-aos="fade-up" data-aos-delay="400">
                                <a href="quote.htm" class="btn btn-primary">Request Quote</a>
                            ...
                            <div class="hero-stats" data-aos="fade-up" data-aos-delay="500">
                                <div class="row">
                                    <div class="col-lg-3 col-md-6">
                                        <div class="stat-item">
                                            <span class="stat-number" data-purecounter-start="0"
                                                data-purecounter-end="250" data-purecounter-duration="2">250</span>
                                    ...
                                    <div class="col-lg-3 col-md-6">
                                        <div class="stat-item">
                                            <span class="stat-number" data-purecounter-start="0"
                                                data-purecounter-end="98" data-purecounter-duration="2">98</span>
                ...
                <div class="testimonial-masonry">
                    ...
                    <div class="testimonial-item" data-aos="fade-up" data-aos-delay="500">
                        <div class="testimonial-content">
                            ...
                            <div class="client-info">
                                <div class="client-image">
                                    <img src="{{ asset('assets-guest/img/person/person-m-13.webp') }}"
                                        alt="Client">
            ...
            <div class="container" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="row gy-5">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="team-member" data-aos="fade-up" data-aos-delay="300">
                            <div class="member-img">
                                <img src="{{ asset('assets-guest/img/construction/project-9.webp') }}"
                                    class="img-fluid" alt="">
                            </div>
                            <div class="member-info">
            ...
            <div class="row gy-5">
                ...
                <div class="col-lg-4">
                    <div class="footer-brand">
                        ...
                        <p class="tagline">Innovating the digital landscape with elegant solutions and timeless design.
                        </p>
